...
package com.egugue.licol.ui.common.customtabs;
...
public class CustomTabActivityHelper implements ServiceConnectionCallback {
  ...
  @Inject CustomTabActivityHelper() {
  }
  ...
  public void setUpCustomTabService(final BaseActivity baseActivity) {
    baseActivity.lifecycle()
        .doOnNext(new Consumer<ActivityEvent>() {
        ...
        .compose(bindUntilEvent(baseActivity.lifecycle(), ActivityEvent.DESTROY))
        .subscribe();
  }
